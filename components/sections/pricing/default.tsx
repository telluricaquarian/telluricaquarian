  ...
  plans = [
    ...
    },
    {
      ...
      cta: {
        ...
        href: "/pricing", // adjust later if you have a real checkout URL
      },
      features: [
        "Multiple website templates included",
        "App templates included",
        "Premium blocks and sections",
    ...
    },
    {
      ...
      cta: {
        ...
        href: "/pricing", // adjust later if you want a separate team link
      },
      features: [
